      ...
      child: CachedNetworkImage(
          ...
          progressIndicatorBuilder: (context, url, downloadProgress) => showUser == true
              ? Container(
                  width: width,
                  height: height,
                  decoration: BoxDecoration(color: Colors.grey.shade100, borderRadius: BorderRadius.circular(radius ?? 0)),
                  child: Center(child: CupertinoActivityIndicator(radius: 15, color: progressColor)))
              : showLogo == true
                  ? Shimmer.fromColors(
                      baseColor: Colors.grey[300]!,
                      highlightColor: Colors.grey[100]!,
                      child: Container(width: width ?? double.infinity, height: height ?? double.infinity, decoration: BoxDecoration(color: Colors.grey.withOpacity(0.5))))
